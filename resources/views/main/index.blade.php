            ...
            <div class="row" data-aos="fade-up">
                <div class="col-xl-8 stretch-card grid-margin">
                    <div class="position-relative">
                        <img
                            src="{{asset('assets/images/dashboard/banner.jpg')}}"
                            alt="banner"
                            class="img-fluid"
                        />
                            ...
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img
                                                src="{{asset('assets/images/dashboard/home_4.jpg')}}"
                                                alt="thumb"
                                                class="img-fluid"
                                            />
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 grid-margin">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img
                                                src="{{asset('assets/images/dashboard/home_5.jpg')}}"
                                                alt="thumb"
                                                class="img-fluid"
                                            />
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="position-relative">
                                        <div class="rotate-img">
                                            <img
                                                src="{{asset('assets/images/dashboard/home_6.jpg')}}"
                                                alt="thumb"
                                                class="img-fluid"
                                            />
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('assets/images/dashboard/home_7.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                  ...
                                  >
                                        ...
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('assets/images/dashboard/home_8.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('assets/images/dashboard/home_9.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                  ...
                                  >
                                        ...
                                        <div class="col-sm-6 grid-margin">
                                            <div class="position-relative">
                                                <div class="rotate-img">
                                                    <img
                                                        src="{{asset('assets/images/dashboard/home_10.jpg')}}"
                                                        alt="thumb"
                                                        class="img-fluid"
                                                    />
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    >
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('assets/images/dashboard/home_11.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                    ...
                                    >
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('assets/images/dashboard/home_12.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                    ...
                                    >
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('assets/images/dashboard/home_13.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                    ...
                                    >
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('assets/images/dashboard/home_14.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
                                    ...
                                    >
                                        <div class="div-w-80 mr-3">
                                            <div class="rotate-img">
                                                <img
                                                    src="{{asset('assets/images/dashboard/home_15.jpg')}}"
                                                    alt="thumb"
                                                    class="img-fluid"
                                                />
                                            </div>
